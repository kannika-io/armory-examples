...
```bash
./setup armory --version 0.14.1 --license /path/to/license.key
```
...
| `KANNIKA_VERSION` | `0.14.1` | Kannika version to install |
...
```bash
./setup armory --cluster my-cluster --version 0.14.1
